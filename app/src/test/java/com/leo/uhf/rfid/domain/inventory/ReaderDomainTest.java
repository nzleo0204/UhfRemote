...
import com.leo.uhf.rfid.domain.tag.ChipModelFormatter;
...
public class ReaderDomainTest {
    ...
    public void mapsRm70xxSubtypesExactly() {
        ...
        assertTrue(ModuleSubtype.RM8011.isQilian());
        assertEquals(1, ModuleSubtype.RM8011.getRawValue());
        assertEquals(3000, ModuleSubtype.RM8011.getDefaultSerialReadyDelayMs());
    }
