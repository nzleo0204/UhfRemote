package com.leo.uhf.rfid.demo.connection;
...
import com.leo.uhf.rfid.persistence.MmkvSerialConfigStore;
import com.leo.uhf.rfid.persistence.SerialConfigStore;
...
public final class SerialConfigDialog {
    public static final class Builder extends StyleDialog.Builder<Builder> {
        ...
        public Builder(@NonNull Context context, @NonNull SerialConfigStore configStore) {
            ...
            moduleTypeView.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                @Override
                public void onItemSelected(AdapterView<?> parent, View view,
                        int position, long id) {
                    ModuleSubtype subtype = subtypeAt(position);
                    if (powerDelayValue() == automaticDelayMs) {
                        powerDelayView.setText(String.valueOf(subtype.getDefaultSerialReadyDelayMs()));
                    }
                    automaticDelayMs = subtype.getDefaultSerialReadyDelayMs();
                }
        ...
        private void bindSavedConfig(@Nullable SerialConfig saved) {
            ...
            automaticDelayMs = config.moduleSubtype.getDefaultSerialReadyDelayMs();
        }
        ...
        private ModuleSubtype subtypeAt(int position) {
        ...
        private int powerDelayValue() {
            try {
                return Integer.parseInt(String.valueOf(powerDelayView.getText()).trim());
