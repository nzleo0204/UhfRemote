...
import com.leo.uhf.rfid.platform.android.service.ReaderService;
import com.leo.uhf.rfid.platform.android.service.ReaderConnectionServiceController;
import com.leo.uhf.rfid.sdk.linkage.UhfNativeBridge;
...
public final class ReaderSessionCoordinator {
    ...
    /** 创建生产环境协调器，集中封装 Linkage 和 Android 依赖装配。 */
    public static ReaderSessionCoordinator createProduction(Application application,
            java.util.function.Function<ReaderProgress, String> messageResolver,
            ReaderConnectionServiceController serviceController) {
        UhfNativeBridge gateway = new UhfNativeBridge();
        return new ReaderSessionCoordinator(gateway, gateway, gateway, gateway,
                SessionDeps.production(application, messageResolver), serviceController);
    }
    ...
    ReaderSessionCoordinator(ReaderTransportGateway transportGateway,
        ...
        connectionManager.setSerialConnector(connectionOrchestrator::connectSerial);
    ...
    public void initializeNativeAtApplication() {
