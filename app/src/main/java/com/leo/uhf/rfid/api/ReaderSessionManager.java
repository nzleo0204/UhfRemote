package com.leo.uhf.rfid.api;

import com.leo.uhf.rfid.platform.android.service.ReaderConnectionService;
import com.leo.uhf.rfid.platform.android.service.ReaderConnectionServiceController;
import com.leo.uhf.rfid.platform.android.service.ReaderServiceNotificationConfig;
import com.leo.uhf.rfid.api.model.*;
import com.leo.uhf.rfid.session.ReaderProgress;
import com.leo.uhf.rfid.session.ReaderSessionCoordinator;
            ...
            synchronized (ReaderSessionManager.class) {
                if (instance == null) {
                    ...
                    instance = new ReaderSessionManager(
                            ReaderSessionCoordinator.createProduction(application,
                                    messageResolver, services), services, notificationConfig);
                }
            }
        }
        return instance;
