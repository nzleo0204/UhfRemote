package com.leo.uhf.rfid.sdk.connection.service;
...
public final class ReaderConnectionService extends Service {
    ...
    public static final String ACTION_START = "com.leo.uhf.reader.action.START";
    static final String ACTION_DISCONNECT = "com.leo.uhf.reader.action.DISCONNECT";
    ...
    private Notification buildNotification() {
        ...
        if (state.isConnected()) {
            String target = state.getTransport() == ConnectionType.WIFI
    ...
    private void updateWifiLock(ReaderState updated) {
        ...
        boolean shouldHold = updated.getTransport() == ConnectionType.WIFI
