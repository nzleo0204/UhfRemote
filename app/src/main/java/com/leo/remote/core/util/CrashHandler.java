...
public final class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(@NonNull Thread thread, @NonNull Throwable throwable) {
        SharedPreferences sharedPreferences = application.getSharedPreferences(CRASH_FILE_NAME, Context.MODE_PRIVATE);
        ...
        if (nextHandler != null && !nextHandler.getClass().getName().startsWith("com.android.internal.os")) {
