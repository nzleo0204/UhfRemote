...
public interface BundleAction {
    ...
    @Nullable
    default <P extends Parcelable> P getParcelable(String name, Class<P> clazz) {
        Bundle bundle = getBundle();
        if (bundle == null) {
            return null;
        }
    ...
    @Nullable
    default <S extends Serializable> S getSerializable(String name, Class<S> clazz) {
        Bundle bundle = getBundle();
        if (bundle == null) {
            return null;
        }
